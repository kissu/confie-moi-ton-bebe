...
<template>
  <div ref="dockRef" :class="cn(
    'supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 mx-auto mt-8 flex h-[58px] w-max rounded-2xl border-0 border-dashed p-2 backdrop-blur-md transition-all',
    $props.class,
    dockClass,
  )
