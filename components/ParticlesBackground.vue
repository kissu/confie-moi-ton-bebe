...
<template>
  <svg viewBox="0 0 1440 181"
    class="border border-blue-500 max-w translate-x-0 border-opacity-20 w-1/2 mx-auto max-w-5xl" fill="none"
    ...
    <defs>
      <linearGradient id="paint0_linear_414_5526" x1="720" y1="0" x2="720" y2="181" gradientUnits="userSpaceOnUse">
        ...
        <stop offset=".5" :stop-color="props.color" stop-opacity="0" />
      </linearGradient>
